CREATE TABLE films (id SERIAL PRIMARY KEY, film_name VARCHAR(255), janre_id INT, release_date DATE, rejiser_id int, descript TEXT, rate FLOAT, poster BYTEA, user_id INT);
...
ALTER TABLE films ADD CONSTRAINT regisr FOREIGN KEY (rejiser_id) REFERENCES rejis(Id);
